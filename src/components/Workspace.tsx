  ...
  return (
    <div className="site-shell flex min-w-0 w-full flex-1 flex-col">
      ...
      <div className="px-3 pt-2">
        <div
          ref={glassRef}
          className="liquid-glass liquid-glass--deck flex flex-wrap items-center justify-between gap-x-4 gap-y-2 px-4 py-2.5"
        >
      ...
      {viewMode === "clock" ? (
        ...
        <>
          ...
          <RecommendationCard />
          <DragHint />
          <div className="min-h-0 min-w-0 flex-1 p-3 pt-2 md:p-4 md:pt-3">
            <TimeGrid />
          </div>

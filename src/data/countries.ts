...
> = [
  ...
  { code: "SY", nameZh: "叙利亚", nameEn: "Syria", weekendDays: [5, 6] },
  { code: "JO", nameZh: "约旦", nameEn: "Jordan", weekendDays: [5, 6] },
  ...
  // 非洲
  { code: "EG", nameZh: "埃及", nameEn: "Egypt", weekendDays: [5, 6] },
  { code: "LY", nameZh: "利比亚", nameEn: "Libya", weekendDays: [5, 6] },
  { code: "TN", nameZh: "突尼斯", nameEn: "Tunisia", weekendDays: [6, 7] },
  { code: "DZ", nameZh: "阿尔及利亚", nameEn: "Algeria", weekendDays: [5, 6] },
  { code: "MA", nameZh: "摩洛哥", nameEn: "Morocco", weekendDays: [6, 7] },
  { code: "SD", nameZh: "苏丹", nameEn: "Sudan", weekendDays: [5, 6] },
